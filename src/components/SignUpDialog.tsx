...
export function SignUpDialog({ open, onOpenChange }: SignUpDialogProps) {
  ...
  const handleSocialSignUp = (provider: 'google' | 'instagram' | 'apple') => {
    // Mock auto-population of user data from social login
    const mockData = {
      google: {
        firstName: 'John',
        lastName: 'Doe',
      ...
      instagram: {
        firstName: 'Jane',
        lastName: 'Smith',
        email: 'janesmith@instagram.com',
      },
      apple: {
        firstName: 'Alex',
        lastName: 'Johnson',
        email: 'alexjohnson@icloud.com',
      },
    };
